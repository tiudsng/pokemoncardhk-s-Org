...
export const AuthPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[var(--bg)] relative overflow-hidden transition-colors duration-500">
      ...
      >
        <div className="flex flex-col items-center">
            ...
            {!isLogin && (
              <motion.div variants={itemVariants} className="relative group">
                ...
                <input
                  type="text"
                  placeholder="全名"
                  className="block w-full pl-14 pr-5 py-[18px] bg-gray-50/50 dark:bg-white/5 border border-gray-100 dark:border-white/5 rounded-2xl text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-4 focus:ring-[#5850EC]/10 focus:border-[#5850EC] focus:bg-white dark:focus:bg-white/10 transition-all outline-none font-medium text-[15px]"
                />
              </motion.div>
            )}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full py-[16px] px-6 bg-white dark:bg-white/5 border border-gray-100 dark:border-white/5 text-gray-700 dark:text-gray-300 rounded-2xl font-bold shadow-sm transition-all mb-10 flex items-center justify-center gap-3 text-[15px]"
          >
